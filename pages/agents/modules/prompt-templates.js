...
⚠️ 重要提示：
- 只输出分析结果，不要输出"热门"、"TOP1"、"今日爆款"、"阅读量"、"讨论量"等元数据
- 标题只出现一次，不要重复
- 不要输出任何与内容分析无关的信息
...
⚠️ 重要提示：
- 只输出分析结果，不要输出"热门"、"TOP1"、"今日爆款"、"阅读量"、"讨论量"、"热度评分"等元数据
- 标题只出现一次，不要重复
- 不要输出任何与内容分析无关的信息
...
⚠️ 重要提示：
- 只输出脚本内容，不要输出"热门"、"TOP1"、"阅读量"、"讨论量"等元数据
- 标题只出现一次，不要重复
- 不要输出任何与脚本内容无关的信息
...
⚠️ 重要提示：
- 只输出脚本内容，不要输出"热门"、"TOP1"、"阅读量"、"讨论量"、"热度评分"等元数据
- 标题只出现一次，不要重复
- 不要输出任何与脚本内容无关的信息
- 输出的是可用的脚本内容，不是示例
...
3. **重要**：每个分镜必须额外输出一行AI绘画Prompt，格式如下：
   - AI绘画Prompt: [简洁的英文提示词，包含主体、场景、风格、质量关键词]
   - 例如：AI绘画Prompt: A young woman in a modern office, looking at her watch, warm lighting, cinematic, 8k, professional photography
